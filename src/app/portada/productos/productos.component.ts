...
export class ProductosComponent implements OnInit {
  ...
  getProductosRecomendado(){
    this._productos.getStore( { where:{ pro_activo: 0, idPrice: this.query.where.idPrice }, sort: "createdAt DESC", page: 0, limit: 6 }).subscribe((res:any)=>{ console.log(res); this.listProductosRecomendar = res.data; }, ( error )=> { console.error(error); });
  }
